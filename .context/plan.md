...
| figures | 0.9.0 | **Epic #31 complete.** All 7 phases merged: scaffold, `scientific-figure`, `transparent-icons`, `figure-qa` agent, `svg-figure`, `ai-full-figure`, `plot-styling`. |
