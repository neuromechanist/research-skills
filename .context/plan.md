...
| figures | 0.4.0 | **Epic #31 in progress.** Phase 1 (scaffold) merged. Phase 2 (`scientific-figure` skill: svgutils composer + font validation + Inkscape/cairosvg exporter) in progress / merging. |
