...
| figures | 0.8.0 | **Epic #31 in progress.** Phases 1–6 merged (scaffold, `scientific-figure`, `transparent-icons`, `figure-qa` agent, `svg-figure`, `ai-full-figure`). Phase 7 pending. |
