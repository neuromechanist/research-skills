...
| figures | 0.4.0 | **Epic #31 in progress.** Phase 1 (scaffold) and Phase 2 (`scientific-figure` skill: svgutils composer + font validation + Inkscape/cairosvg exporter) merged. Phases 3–7 pending. |
