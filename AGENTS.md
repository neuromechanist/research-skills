...
│   │   └── agents/templates/grant-review.{toml,agent.md}
...
- **grant** (v0.3.4): NIH/NSF grant proposal writing, structured review with scoring criteria, and figure quality assurance. Cross-references `manuscript:humanizer` from grant-writing and grant-review for natural-writing passes. Agents: `grant-review` (independent fresh-context reviewer, epic #61) and `grant-figure-qa`, both Claude-bundled, with Codex/Copilot reviewer shell templates in `agents/templates/`.
