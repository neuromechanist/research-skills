...
│   │   ├── .codex-plugin/plugin.json
│   │   └── skills/opencite/
│   ├── figures/                      # Publication-quality figures (v0.10.3)
│   │   ├── .claude-plugin/plugin.json
│   │   ├── .codex-plugin/plugin.json
