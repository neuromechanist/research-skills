...
│   │   ├── .codex-plugin/plugin.json
│   │   └── skills/opencite/
│   ├── figures/                      # Publication-quality figures (v0.10.2)
│   │   ├── .claude-plugin/plugin.json
│   │   ├── .codex-plugin/plugin.json
