...
│   │   ├── skills/{init-project,project-preflight,update-rules,install-user-instructions,workflow-reference,epic-dev,pr-review-toolkit,codebase-onboarding,implementation-planning,engineering-loop,debugging,agent-fanout,ci-scaffolding,docker-packaging,security-audit,document-processing}/
...
│   │   └── bin/                     # project-preflight, project-init-templates, project-diff-rules, project-templates-path
...
│   │   ├── .github/plugin/plugin.json
│   │   └── skills/opencite/
│   ├── figures/                      # Publication-quality figures (v0.13.0)
│   │   ├── .claude-plugin/plugin.json
│   │   ├── .codex-plugin/plugin.json
│   │   ├── .github/plugin/plugin.json
