...
1. Applications assigned to a Scientific Review Group (study section)
...
### Reviewer Roles
- **Primary reviewer**: Presents first, gives detailed critique
- **Secondary reviewer**: Adds perspective, may raise additional points
...
### Inclusion of Women, Minorities, and Persons Across the Lifespan
- Study population reflects disease/condition demographics
- If not, scientific justification provided

### Vertebrate Animals (if applicable)
- Justification for animal use
- Procedures to minimize suffering
- IACUC approval
...
- Compliant with NIH DMS Policy (2023+)
- Timeline for sharing
- Repository selection
- Budget for data sharing

### Budget and Period of Support
- Budget justified and appropriate
